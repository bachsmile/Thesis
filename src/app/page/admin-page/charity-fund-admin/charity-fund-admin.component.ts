...
@Component({
  selector: 'app-charity-fund-admin',
  templateUrl: './charity-fund-admin.component.html',
  styleUrls: ['./charity-fund-admin.component.scss']
})
export class CharityFundAdminComponent implements OnInit {
  MoneyInput=[];
  MoneyOutput=[];
  AllINPut=0;
  AllOutPut=0;

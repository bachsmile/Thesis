...
export class ChatComponent implements OnInit, AfterViewInit {
  ...
  constructor(private socketService: SocketService,private link:LinkService,
  ...
  private initIoConnection(): void {
    ...
    this.socketService.onEvent(Event.DISCONNECT)
     ...
     this.socketService.OngetCLient()
      .subscribe(x=> {
        console.log(x);
      });

      this.socketService.OnGetRoom()
      .subscribe(x=> {
        console.log(x);
      });
      this.socketService.OnGetUserChat()
      .subscribe(x=> {
        this.listChat=x;
        console.log(x);
      });
  ...
  c(){
    this.socketService.listUserChat();
  }
  checkT(){
    this.link.check=!this.link.check;
   setTimeout(() => {
